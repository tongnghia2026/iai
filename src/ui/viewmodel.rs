...
pub struct ToolViewModel {
    ...
    pub arrow_end: u8,
    pub arrow_route: u8,
    /// Arrow tool mode: 0 single, 1 branch (drag a trunk then add sub-arrows),
    /// 2 tree (org-chart connector).
    pub arrow_mode: u8,
    /// Down-arrow count for tree mode.
    pub arrow_tree_count: u8,
    pub arrow_path: Vec<(f32, f32)>,
    /// Preview polylines for the org-chart connector while dragging in tree mode
    /// (canvas space); empty in the other modes.
    pub arrow_preview_contours: Vec<Vec<(f32, f32)>>,
...
pub struct SelectionViewModel {
    ...
    pub yolo_people_only: bool,
    pub show_refine_panel: bool,
    pub refine_params: crate::core::refine::RefineParams,
    pub refine_can_undo: bool,
    pub refine_can_redo: bool,
    pub refine_view_opacity: f32,
    pub refine_show_original: bool,
    ...
    /// Preview texture of the live selection; None when the view draws none.
    ...
    fn default() -> Self {
        Self {
            ...
            tool: ToolViewModel {
                ...
                arrow_tree_count: 5,
                arrow_path: Vec::new(),
                arrow_preview_contours: Vec::new(),
            ...
            sel: SelectionViewModel {
                ...
                yolo_people_only: false,
                show_refine_panel: false,
                refine_params: crate::core::refine::RefineParams::default(),
                refine_can_undo: false,
                refine_can_redo: false,
                refine_view_opacity: 1.0,
                refine_show_original: false,
                refine_decontaminate: false,
                refine_decontaminate_amount: 0.5,
                refine_brush_size: 80.0,
