...
pub struct WindowRuntime {
    ...
    /// A keyboard/IME event was handed to the live TextEdit and caused the next
    /// UI frame. Strict-modal bookkeeping generated by that frame must not ring
    /// the blocked-action bell; real pointer/menu denials use separate paths.
    pub(in crate::app) text_input_frame_pending: bool,
